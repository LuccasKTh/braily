<x-app-layout>
    ...
    {{-- <div id="sticky-banner" tabindex="-1" class="fixed top-0 start-0 z-50 w-full flex justify-between p-4 border-b border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
